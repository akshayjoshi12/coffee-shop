...
final class Gutenbiz_Theme extends Gutenbiz_Helper{
	...
	*/
	public static function get_footer_widget(){
		...
		if( is_page() && $disable_footer ){
			return true;
		}elseif( self::is_active_plugin( 'woocommerce' ) && is_shop() && $disable_footer ){
			return true;
		}
	}
	...
	*/
	public static function the_inner_banner_content( ){
		...
		if( 
			...
			is_404() ||
			# don't load if it is disabled on woocommerce shop page
			( ( is_page() || self::is_woo_shop_page() ) && self::get_meta( 'disable-inner-banner' ) ) ||
	...
	*/
	...
	/**
	* Adds cart icon on header id woocommerce is active
	*
	* @static
	* @access public
	* @since  1.0.5
