...
class Gutenbiz_Customizer_Loader extends Gutenbiz_Helper{
	...
	public static function script(){
		...
		wp_localize_script( self::with_prefix( 'customize-js' ), 'gutenbizColorPalette',
			array( 
				'colorPalettes' => array(
					'#000000',
					'#ffffff',
...
new Gutenbiz_Customizer_Loader();
