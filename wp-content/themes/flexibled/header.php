    	...
    	<div class="top-right">        	
            <div class="phone">
            	<?php if(get_theme_mod('phone-txt') != '') { ?>              	
                    <i class="fa fa-envelope-o"></i><a href="<?php echo esc_attr(esc_html('mailto:','flexibled').get_theme_mod('email-txt')); ?>"><?php echo esc_attr(get_theme_mod('email-txt')); ?></a>
				<?php }?>            	
            </div>
            <div class="clear"></div>
